...
from experiments.molesol.model import build_subcomplex_ensemble_model, build_homp_model
...
def get_model(cfg):
    ...
    if cfg.arch.model_type == "subcomplex":
        return build_subcomplex_ensemble_model(
            ...
            device=cfg.device,
            output_ranks_cin=[0, 1],
            output_ranks_subgraphs=cfg.arch.output_ranks_subgraphs,  # [0,2]
...
def get_dataloaders(
    ...
    dataset = PygGraphPropPredDataset(name="ogbg-molesol", root=original_root)
